...
QtObject {
    ...
    readonly property string backupStateLoading: qsTr("Loading")
    readonly property string backupStatePaused: qsTr("Paused")
    readonly property string backupStateDisabled: qsTr("Disabled")
