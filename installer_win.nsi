...
; 4 = You already have a MEGA Desktop App installed. Please, uninstall it first and then reinstall it.
...
PluginFail:
  !insertmacro ExitWithError 1 "Error! Unable to call UserInfo plug-in!"
RunElevated:
  UAC::RunElevated
  ${Switch} $0
  ${Case} 0
    ...
    ${If} $1 = 3 ;RunAs completed successfully, but with a non-admin user
      ...
      !insertmacro ExitWithError 1 "This installer requires Administrator privileges. Error $0"
    ${EndIf}
  ${Case} 1223
    !insertmacro ExitWithError 1 "This installer requires Administrator privileges. Error $0"
  ${Default}
...
Function .onInit
  ...
  ${If} ${RunningX64}
  ${Else}
    !insertmacro ExitWithError 2 "This is an installer for 64-bit MEGA Desktop App, but you are using a 32-bit Windows. Please, download the 32-bit MEGA Desktop App version from https://mega.io/desktop."
  ${EndIf}
  !endif

  ${IfNot} ${AtLeastWin10}
	!insertmacro ExitWithError 3 "This MEGA Desktop App installer is for Windows 10 or above"
  ${EndIf}
